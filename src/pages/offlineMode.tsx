				...
				{!activeFeature ? (
					<>
						<div>
							...
							<Description>
								Manage your wallet securely in offline mode. You can recover wallets, export keys, and perform other wallet
								operations without connecting to the blockchain.
							</Description>
						</div>
