...
const ExportMnemonic: React.FC<ExportMnemonicProps> = ({ onBack }) => {
	...
	return (
		<Container>
			...
			<ContentContainer>
				<WarningBox>
					⚠️ <strong>Warning:</strong> Never share your mnemonic phrase with anyone. Anyone with access to your mnemonic can
					control your wallet and funds.
				</WarningBox>

				{!showMnemonic ? (
					<>
						<InfoBox>
							Your mnemonic phrase is the master key to your wallet. Write it down and store it in a secure location. You will
							need it to recover your wallet if you lose access.
						</InfoBox>
