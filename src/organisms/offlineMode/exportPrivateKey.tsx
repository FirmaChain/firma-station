	...
	return (
		<Container>
			...
			<ContentContainer>
				<WarningBox>
					<p>
						🔴 <strong>Extreme Caution:</strong> Your private key gives complete control over your wallet. Never share it with
						anyone or enter it on untrusted websites.
					</p>
				</WarningBox>
				...
				{!showPrivateKey ? (
					...
					<>
						...
						<WarningBox>
							⚠️ This private key controls your wallet completely. Store it securely and never share it with anyone. Consider
							deleting it from your clipboard after use.
						</WarningBox>
