		...
		<Container>
			...
			<ContentContainer>
				<PreviewContainer>
					<PreviewImage />
					<PreviewDescription>
						A paper wallet is a physical document containing your wallet's private key and mnemonic phrase. It provides an
						offline backup solution for your cryptocurrency wallet.
					</PreviewDescription>
				</PreviewContainer>
				...
				<InfoBox>
					🔒 The paper wallet will contain sensitive information including your private key and mnemonic phrase. Store it in a
					secure location and never share it with anyone.
				</InfoBox>
