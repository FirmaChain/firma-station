...
export const DepositContent = styled.div`
  ...
  ${(props) =>
    props.bigSize &&
    `font-size:${({ theme }) => theme.sizes.depositCardSize2};color:${({ theme }) => theme.colors.defaultGray}`}
`;
...
export const DepositButton = styled.div`
  ...
  ${(props) =>
    props.active
      ? ``
      : `background-color: ${({ theme }) => theme.colors.defaultGray5};color:${({ theme }) =>
          theme.colors.defaultGray6}`}
`;
...
export const VotingContent = styled.div`
  ...
  ${(props) =>
    props.bigSize &&
    `font-size:${({ theme }) => theme.sizes.votingCardSize2};color:${({ theme }) => theme.colors.defaultGray};`}
`;
...
export const VotingButton = styled.div`
  width: 100px;
  height: 40px;
  line-height: 40px;
  text-align: center;
