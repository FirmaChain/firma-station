...
const ConfirmWalletModal = () => {
	...
	const checkWord = () => {
		activeCreateButton(inputTarget[0].text === inputTarget[0].mnemonic && inputTarget[1].text === inputTarget[1].mnemonic);
	};
	...
	return (
		<Modal visible={confirmWalletModalState} closable={true} onClose={cancelWallet} prev={prevModal} width={confirmWalletModalWidth}>
			<ModalContainer>
				<ModalTitle>
					Confirm Wallet
