...
const RedelegateModal = () => {
	...
	return (
		<Modal visible={redelegateModalState} closable={true} visibleClose={false} onClose={closeModal} width={redelegateModalWidth}>
			<ModalContainer>
				<ModalTitle>
					Redelegate
				...
				<ModalContent>
					...
					<SelectWrapper>
						<Select
							...
							value={sourceValidator ? ((delegationList as any[]).find((v) => v.value === sourceValidator) ?? null) : null}
							styles={customStyles}
