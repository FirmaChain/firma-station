...
const RestakeModal = () => {
	...
	useEffect(() => {
		if (restakeModalState) {
			...
			modalData.totalDelegated && setTotalDelegated(`${getFCTFormat(modalData.totalDelegated)} ${CHAIN_CONFIG.PARAMS.SYMBOL}`);
			modalData.totalRewards && setTotalRewards(`${getFCTFormat(modalData.totalRewards)} ${CHAIN_CONFIG.PARAMS.SYMBOL}`);
		}
	...
	return (
		<Modal visible={restakeModalState} closable={true} visibleClose={false} onClose={closeRestakeModal} width={restakeModalWidth}>
			<ModalContainer>
