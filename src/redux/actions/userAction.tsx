...
export const handleUserTokenList = (tokenList: any[]) => ({ type: HANDLE_USER_TOKEN_LIST, tokenList });
export const handleUserNFTList = (nftList: any[]) => ({ type: HANDLE_USER_NFT_LIST, nftList });
